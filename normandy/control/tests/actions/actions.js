...
describe('controlApp Actions', () => {
  ...
  it ('creates SET_SELECTED_RECIPE when selecting a recipe', () => {
    const expectedAction = { type: actions.SET_SELECTED_RECIPE, recipeId: 2 };
    store.dispatch(actions.setSelectedRecipe(2));
